      ...
      <Columns id="col">
        ...
        <Columns.Column>
          <Card style={{ width: 300, margin: 'auto' }}>
            ...
            <Card.Content>
              <a
                href="https://github.com/Nico749/Financial_Analysis"
                target="_blank"
                rel="noopener noreferrer"
                id='cardtitle'
                className=' is-size-3 has-text-black'
              ...
              <p id='cardbody' className="is-size-5 has-text-black">
                ...
                > Click here</a> to go to the Github repo or have a look at the <a
                  id="cardlink"
                  href="https://github.com/Nico749/Financial_Analysis/blob/main/Google_SF_Oracle.ipynb"
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() => window.dataLayer.push({
                    event: 'project_click',
